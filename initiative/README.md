...
| `cut-1-ryan-brief.md` | Cut 1: one-page internal brief for Ryan Weigand (UVA Corporate & Foundation Relations). Template for future audience cuts. |
| `messaging-map.md` | The locked narrative architecture: spine, headline system, aphorism variants, stakeholder map, tone law, usage rules. Component sheet for designing artifacts. |
| `design-prompt.md` | Ready-to-paste Claude Design prompt (two-sided brief series) + upload list, regenerated against the locked architecture. |
