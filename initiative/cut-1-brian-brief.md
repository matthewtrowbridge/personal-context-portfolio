...
**Why UVA.** The referee role requires trust neither developers nor advocates can supply — only a university can. Virginia is both the data center capital of the world and ground zero for the conflict (Warrenton). Darden faculty are already publishing on data center community costs; the Center for Real Estate supplies the practitioner network; the LaCross AI Institute makes this the infrastructure-and-society pillar of a commitment UVA has already made. No university has claimed this chair. Within eighteen months, one will have.
...
3. **Standards partnerships (year 2+).** Pilot validated instruments with LEED, GRESB, and peers — benchmark before certify, the proven path from tools to industry transformation.
